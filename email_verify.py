...
https://booksydb.herokuapp.com/verify?token={token}

It'll expire in approximately 24 hours. If you did not register a library with Booksy, please disregard this message.
'''
