...
app.static('/dist/index.html', '/dist/index.html') # Route everything to Angular's file, even if the user navigates directly to it (think this is how it works)
...
async def close_dbs(app, loop):
    """
    Sign off by gracefully closing the connection with the env's DBs.
    """
